...
export default [
    ...
    },
    {
        ...
        mapping: {
            ...
            syntax_arrowfunctions: 'syntax.arrow_functions',
            syntax_destructuring: 'syntax.destructuring',
            syntax_spreadoperator: 'syntax.spread_operator',

            language_asyncawait: 'language.async_await',
            language_decorators: 'language.decorators',
            language_promises: 'language.promises',
            language_proxies: 'language.proxies',

            datastructures_arrayprototypeflat: 'data_structures.array_prototype_flat',
            datastructures_maps: 'data_structures.maps',
            datastructures_sets: 'data_structures.sets',
            datastructures_typedarrays: 'data_structures.typed_arrays',

            browserapis_fetchapi: 'browser_apis.fetch',
            browserapis_i18n: 'browser_apis.i18n',
            browserapis_localstorage: 'browser_apis.local_storage',
            browserapis_serviceworkers: 'browser_apis.service_workers',
            browserapis_webanimationsapi: 'browser_apis.web_animations',
            browserapis_webaudioapi: 'browser_apis.web_audio',
            browserapis_webcomponents: 'browser_apis.web_components',
            browserapis_webgl: 'browser_apis.webgl',
            browserapis_webrtc: 'browser_apis.webrtc',
            browserapis_websocket: 'browser_apis.websocket',
            browserapis_webspeechapi: 'browser_apis.web_speech',
            browserapis_webvr: 'browser_apis.webvr',

            otherfeatures_progressivewebappspwa: 'other_features.pwa',
            otherfeatures_webassemblywasm: 'other_features.wasm',
