...
// features
export const FIELD_TYPE_FEATURE_EXPERIENCE = 'feature_experience'
export const FIELD_TYPE_OTHER_FEATURE = 'other_feature'

export const FIELD_TYPE_ENVIRONMENT_CHOICES = 'environment_choices'
export const FIELD_TYPE_ENVIRONMENT_RATING = 'environment_rating'
export const FIELD_TYPE_RESOURCE = 'resource'
...
export const FIELD_TYPE_CITY = 'city'
export const FIELD_TYPE_PROFICIENCY = 'proficiency'
export const FIELD_TYPE_JOB_TITLE = 'job_title'
