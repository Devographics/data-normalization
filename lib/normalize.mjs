...
export const isValidNormalization = (value, rules) => rules.some(ruleArray => {
...
export const normalizeResponseSource = response => {
    const [normalizedFindOut, findOutPattern] = normalizeSource(response.how_did_user_find_out_about_the_survey)
...
const toolNormalizationRules = [
    ...
    [/wallaby/i, 'wallaby'],
    [/vue\-test\-utils/i, 'vue-test-utils'],
    [/testing\-library/i, 'react-testing-library'],
    ...
    [/ie11/i, 'ie11'],
    [/ie 11/i, 'ie11'],
    [/firefox developer edition/i, 'firefox-developer-edition'],
    [/edge chromium/i, 'edge-chromium'],
    [/edge \(chromium\)/i, 'edge-chromium'],
    [/chromium/i, 'chromium'],

    [/tsc/i, 'tsc'],
    [/shadow/i, 'shadow-cljs'],
    [/pika/i, 'pika'],
    [/lerna/i, 'lerna'],
    [/create-react-app/i, 'create-react-app'],
    [/cra/i, 'create-react-app'],
    [/angular-cli/i, 'angular-cli'],
    [/angular cli/i, 'angular-cli'],
    [/vue-cli/i, 'vue-cli'],
    [/vue cli/i, 'vue-cli'],
    [/metro/i, 'metro'],
...
export const normalizeResources = multiNormalizer(toolNormalizationRules)
